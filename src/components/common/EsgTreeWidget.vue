...
<template>
  <div class="mt-auto shrink-0 px-3 pb-3">
    <div
      class="overflow-hidden rounded-2xl bg-gradient-to-br from-sky-50 via-emerald-50 to-emerald-100 p-3 ring-1 ring-emerald-100/80"
    >
      ...
      <div class="flex h-36 items-end justify-center">
      ...
      <div class="mt-1 space-y-1.5">
        <div class="flex items-baseline justify-between">
          <span class="text-[10px] font-semibold text-gray-700">{{ stageLabel }}</span>
          <span class="text-[10px] font-bold text-emerald-700">
            {{ totalPoints.toLocaleString() }}P
          </span>
        </div>
        <div class="h-1.5 w-full overflow-hidden rounded-full bg-white/80">
          <div
